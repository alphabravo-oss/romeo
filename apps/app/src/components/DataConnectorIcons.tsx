...
import type { DataConnectorType } from "../features/data-connectors";
...
function S3Icon(): React.ReactNode {
  ...
  return (
    <svg aria-hidden="true" height={SIZE} viewBox="0 0 24 24" width={SIZE}>
      <path
        d="M5 4h14l-1.4 15.2a2 2 0 0 1-2 1.8H8.4a2 2 0 0 1-2-1.8L5 4z"
        fill="#E25444"
      />
      <path
        d="M12 4h7l-1.4 15.2a2 2 0 0 1-2 1.8H12V4z"
        fill="#B0332A"
        opacity="0.5"
      />
    </svg>
