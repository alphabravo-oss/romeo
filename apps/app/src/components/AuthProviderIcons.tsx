...
import type { AuthProviderId } from "../features/auth-provider-administration";
...
function Auth0Icon(): React.ReactNode {
  ...
  return (
    <svg aria-hidden="true" height={SIZE} viewBox="0 0 24 24" width={SIZE}>
      ...
      />
      <path
        d="M12 6.5l1.7 5h-3.4L12 6.5zm-3 8.5l1.1-3.3h3.8L15 15l-3-2.2L9 15z"
        fill="#fff"
      />
    </svg>
  );
...
function KeycloakIcon(): React.ReactNode {
  ...
  return (
    <svg aria-hidden="true" height={SIZE} viewBox="0 0 24 24" width={SIZE}>
      <path
        d="M6 3h6l3 4.5-3 4.5 3 4.5L12 21H6l-3-4.5V7.5L6 3z"
        fill="#008AAA"
      />
      <path
        d="M12 3h6l3 4.5v9L18 21h-6l3-4.5-3-4.5 3-4.5L12 3z"
        fill="#33A9C7"
      />
    </svg>
  );
