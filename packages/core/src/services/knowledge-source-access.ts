...
export function filterKnowledgeSourcesForSubject(
...
export function filterKnowledgeChunksForSources(
...
export function canReadKnowledgeSource(
...
function sourceAccess(
  source: KnowledgeSource,
): { mode?: string; ownerId?: string } | undefined {
