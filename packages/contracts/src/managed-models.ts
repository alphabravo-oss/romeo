...
import {
  ...
  managedModelTimestamp,
  parameters,
  ManagedModelMemoryPolicySchema,
  ManagedModelSafetySettingsSchema,
  ManagedModelSchema,
  knowledgeBinding,
  toolBinding,
  ManagedModelVersionEvalSuiteSchema,
  ManagedModelVersionEvalSummarySchema,
  ManagedModelVersionSchema,
  ManagedModelCustomizationPolicySchema,
  ManagedModelPreferencesSchema,
  ...
  portableGrant,
  ManagedModelExportDocumentSchema,
